...
public class DictionaryActivity extends AppCompatActivity {
    ...
    public void save(View view){
        ...
        try {
            database = this.openOrCreateDatabase("Words", MODE_PRIVATE,null);
            database.execSQL("CREATE TABLE IF NOT EXISTS words (id INTEGER PRIMARY KEY, englishname VARCHAR, turkishname VARCHAR, image BLOB)");

            String sqlString = "INSERT INTO words(englishname, turkishname, image) VALUES(?, ?, ?)";
    ...
    public void deleteWord(View view) {
        if (info.equals("old")) {
            ...
            try {
                ...
                database.execSQL("DELETE FROM words WHERE id = ?", new Object[]{wordId});
                      ...
                      // binding.imageView.setImageURI(imageData);
                        try {
                            if (Build.VERSION.SDK_INT >= 28){
                                ...
                                selectedImage = MediaStore.Images.Media.getBitmap(DictionaryActivity.this.getContentResolver(),imageData);
                                binding.imageView.setImageBitmap(selectedImage);
                            }
        ...
        permissionLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
            ...
            public void onActivityResult(Boolean result) {
                if(result) {
                    ...
                    //permission denied
                    Toast.makeText(DictionaryActivity.this, "Permission needed!",Toast.LENGTH_LONG).show();
