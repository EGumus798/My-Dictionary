...
public class DictionaryActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerLauncher();
        database = this.openOrCreateDatabase("Wordsss", MODE_PRIVATE,null);


        Intent intent = getIntent();
        info = intent.getStringExtra("info");

        if (info.equals("newww")){
            //new word
            ...
            try {
                ...
                Cursor cursor = database.rawQuery("SELECT * FROM wordsss WHERE id = ?",new String[] {String.valueOf(wordId)});
    ...
    public void save(View view){
        ...
        try {
            database = this.openOrCreateDatabase("Wordsss", MODE_PRIVATE,null);
            database.execSQL("CREATE TABLE IF NOT EXISTS wordsss (id INTEGER PRIMARY KEY, englishname VARCHAR, turkishname VARCHAR, image BLOB)");

            String sqlString = "INSERT INTO wordsss(englishname, turkishname, image) VALUES(?, ?, ?)";
        ...
        Intent intent = new Intent(DictionaryActivity3.this,MainActivity3.class);
    ...
    public void deleteWord(View view) {
        if (info.equals("olddd")) {
            ...
            try {
                ...
                database.execSQL("DELETE FROM wordsss WHERE id = ?", new Object[]{wordId});
                    ...
                    if (intentFromResult != null){
                        ...
                        try {
                            if (Build.VERSION.SDK_INT >= 28){
                                ...
                                selectedImage = MediaStore.Images.Media.getBitmap(DictionaryActivity3.this.getContentResolver(),imageData);
                                binding.imageView.setImageBitmap(selectedImage);
                            }
        ...
        permissionLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
            ...
            public void onActivityResult(Boolean result) {
                if(result) {
                    ...
                    //permission denied
                    Toast.makeText(DictionaryActivity3.this, "Permission needed!",Toast.LENGTH_LONG).show();
