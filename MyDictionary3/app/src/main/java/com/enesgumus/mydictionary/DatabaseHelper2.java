...
public class DatabaseHelper2 extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "Wordss";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS wordss (id INTEGER PRIMARY KEY, englishname VARCHAR, turkishname VARCHAR, image BLOB)");
    }
    ...
    public List<Word> getAllWords() {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM wordss", null);
