...
public class DictionaryActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerLauncher();
        database = this.openOrCreateDatabase("Wordss", MODE_PRIVATE,null);
        ...
        if (info.equals("neww")){
            ...
            try {
                ...
                Cursor cursor = database.rawQuery("SELECT * FROM wordss WHERE id = ?",new String[] {String.valueOf(wordId)});
    ...
    public void save(View view){
        ...
        try {
            database = this.openOrCreateDatabase("Wordss", MODE_PRIVATE,null);
            database.execSQL("CREATE TABLE IF NOT EXISTS wordss (id INTEGER PRIMARY KEY, englishname VARCHAR, turkishname VARCHAR, image BLOB)");

            String sqlString = "INSERT INTO wordss(englishname, turkishname, image) VALUES(?, ?, ?)";
        ...
        Intent intent = new Intent(DictionaryActivity2.this,MainActivity2.class);
    ...
    public void deleteWord(View view) {
        if (info.equals("oldd")) {
            ...
            try {
                ...
                database.execSQL("DELETE FROM wordss WHERE id = ?", new Object[]{wordId});
                    ...
                    if (intentFromResult != null){
                        ...
                        try {
                            if (Build.VERSION.SDK_INT >= 28){
                                ...
                                selectedImage = MediaStore.Images.Media.getBitmap(DictionaryActivity2.this.getContentResolver(),imageData);
                                binding.imageView.setImageBitmap(selectedImage);
                            }
        ...
        permissionLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
            ...
            public void onActivityResult(Boolean result) {
                if(result) {
                    ...
                    //permission denied
                    Toast.makeText(DictionaryActivity2.this, "Permission needed!",Toast.LENGTH_LONG).show();
